...
-- ║  │    FirstPurchaseDate. Ground truth for the scoring model.           │ ║
-- ║  │                                                                     │ ║
-- ║  │  CTE 2: CustomerSatisfactionProfile                                 │ ║
-- ║  │    Converts raw behavioral metrics into a SatisfactionScore (0–1).  │ ║
-- ║  │    Adds DaysSinceLastPurchase and TenureDays derived from @MaxDate. │ ║
-- ║  │    Joins dbo.DimCustomer to filter to CustomerType = 'Person'.      │ ║
-- ║  │                                                                     │ ║
...
-- ║  1. CROSS APPLY materialises the NPS random draw BEFORE the CSAT draw. ║
...
-- ║  2. SurveyDate is clamped to <= @MaxDate using LEAST(). A customer       ║
...
-- ║  3. V5 referential integrity check validates CustomerKey → DimCustomer. ║
-- ╚═══════════════════════════════════════════════════════════════════════════╝
